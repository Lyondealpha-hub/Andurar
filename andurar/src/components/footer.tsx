...
const LINKS = [
  {
    title: "Product",
    items: ["Overview", "Features", "Facilities"],
  },
  {
    title: "Company",
    items: ["About us", "Our Services", "Contact Us", "Help center"],
  },
  {
    title: "Hotel Services",
    items: ["Conference Hall", "Events", "Luxurious Rooms", "Restaurant"],
  },
];
...
export default function NavFooter() {
  return (
    <footer className="relative w-full mt-5 bg-black text-white">
      <div className=" w-full max-w-7xl mt-2  mx-auto">
        <div className="grid grid-cols-1  md:grid-cols-2 ">
          <div id="stroke-text" className="my-10 py-2 relative after:absolute flex after:flex after:justify-center  before:flex before:justify-center  items-center after:italic after:inset-0 after:z-0 after:content-['Andurar_Hotels'] after:text-white after:-top-0 after:left-0 after:text-5xl  after:h-full after:w-full after:font-sans  before:absolute  before:text-5xl  before:content-[''] text-blue-gray-100  before:-top-4 before:left-8 before:h-full before:w-full before:z-0  before:tracking-widest before:italic  before:font-sans before:uppercase">
            <div className="grid grid-cols-3 justify-between gap-4 mx-auto">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            ...
            &copy; {currentYear} <a href="#">Andurar Hotels Inc</a>. All
            Rights Reserved.
          </Typography>
